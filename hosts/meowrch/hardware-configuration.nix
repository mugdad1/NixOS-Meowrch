...

{
  ...
  ############################################
  fileSystems."/" =
    { device = "/dev/disk/by-uuid/19410c58-281a-4c05-b8d5-f62f29342c87";
      fsType = "ext4";
    };

  fileSystems."/boot" =
    { device = "/dev/disk/by-uuid/C644-A58F";
      fsType = "vfat";
      options = [ "fmask=0077" "dmask=0077" ];
    };

  swapDevices =
    [ { device = "/dev/disk/by-uuid/2ad16947-418e-4353-a18f-75b0d82a4dde"; }
    ];
